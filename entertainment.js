...
async function heroNews(){
    let API_URL =  `https://newsapi.org/v2/top-headlines?category=entertainment&language=en&pageSize=10&apiKey=${API_Key}`;
...
let dropDown = document.getElementById("entertainmentFilter");

async function loadTopheadlines(topic) {

    let cards_Container = document.querySelector(".news-cards")
    cards_Container.innerHTML = "";
    const API_URL = `https://newsapi.org/v2/everything?q=${topic}&language=en&sortBy=publishedAt&pageSize=6&apiKey=${API_Key}`;
