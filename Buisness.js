...
async function heroNews(){
    let API_URL =  `https://newsapi.org/v2/top-headlines?category=business&language=en&pageSize=10&apiKey=${API_Key}`;
...
let dropDown = document.getElementById("businessFilter");
